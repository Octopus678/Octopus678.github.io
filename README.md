...
2. 关于我：个人介绍、数据统计、工作经历时间线、联系方式 + **照片展（复刻 Godly #159 形式）**：米白底 + 中央大圆角设备屏 + 背景大字号竖排滚动词 + 圆点切换，照片自动轮播、点击站内查看大图
3. 精选作品：4 支 9:16 竖屏成片组成**旋转视频柱（复刻 X 帖 WebGL 形式）**：纯黑场景 + 中央发光四棱柱持续原地旋转 + 呼吸光晕，可暂停/继续、悬停暂停、点击画面在站内全屏打开播放
4. 个人优势：6 张能力卡片
