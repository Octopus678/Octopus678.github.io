...
2. 关于我：**159 风格介绍面板**（米白底 + 大字号竖排滚动词）：左侧设备屏照片，右侧 **React Bits Lanyard 交互名片**（3D 物理悬挂卡牌，可拖动翻转，正面为介绍、背面为照片）；下方保留数据统计、经历时间线与联系方式 + **照片展（React Bits Circular Gallery 1:1）**：WebGL 弧形画廊，11 张照片沿弧线排布，拖动 / 滚轮 / 方向键浏览，点击照片站内查看大图
